...
const StripeSubscriptionForm = ({
  ...
  return (
    <div className="fixed inset-0 z-[10000] overflow-y-auto bg-slate-950/70 p-3 backdrop-blur-sm sm:p-4">
      <div className="flex min-h-full items-start justify-center py-3 sm:py-6">
        <div className="flex max-h-[calc(100dvh-1.5rem)] w-full max-w-lg flex-col overflow-hidden rounded-[28px] bg-white shadow-2xl sm:max-h-[calc(100dvh-3rem)]">
          <div className="flex flex-shrink-0 items-start justify-between gap-4 p-5 pb-4 sm:p-6 sm:pb-4">
            <div>
          ...
          <div className="flex flex-shrink-0 gap-3 p-5 pt-4 sm:p-6 sm:pt-4">
            <button
              type="button"
              onClick={onClose}
